...
RegisterNetEvent('fd-megaphones:client:addsubmix', function(id)
	megaphoneEffectId = CreateAudioSubmix('Phone')
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('freq_low'), 10.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('freq_hi'), 10000.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('rm_mod_freq'), 300.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('rm_mix'), 0.2)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('fudge'), 0.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('o_freq_lo'), 200.0)
	SetAudioSubmixEffectParamFloat(megaphoneEffectId, 0, GetHashKey('o_freq_hi'), 5000.0)
